...
public class jEdit {
    ...
    public static void main(String[] args) {
        ...
        if (javaVersion.compareTo("1.8") < 0) {
            System.err.println("你用的java版本 "
                    + javaVersion + '.');
            System.err.println("jEdit要求Java 1.8+.");
            System.exit(1);
        }
        ...
        //{{{ Get things rolling
        GUIUtilities.advanceSplashProgress("初始化");
        initMisc();
        GUIUtilities.advanceSplashProgress("初始化系统属性");
        initSystemProperties();

        GUIUtilities.advanceSplashProgress("初始化脚本");
        BeanShell.init();
        ...
        GUIUtilities.advanceSplashProgress("初始化GUI");
        GUIUtilities.init();
        ...
        //{{{ Do more stuff
        GUIUtilities.advanceSplashProgress("初始化外观");
        initPLAF();
        GUIUtilities.advanceSplashProgress("init VFS Manager");
        VFSManager.init();
        GUIUtilities.advanceSplashProgress("初始化资源");
        initResources();
